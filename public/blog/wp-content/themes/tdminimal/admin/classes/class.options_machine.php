...
class Options_Machine {
	...
	public static function optionsframework_recent_posts_function($id,$std,$oldorder,$order){
		...
		//initialize all vars
		$slidevars = array('title', 'cat_id', 'per_page');
		...
		$slider .= '<input class="slide of-input of-slider-per-page" name="'. $id .'['.$order.'][per_page]" id="'. $id .'_'.$order .'_slide_per_page" value="'. stripslashes($val['per_page']) .'" />';
