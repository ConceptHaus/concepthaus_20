@extends('layouts.appService_col') @section('content')
...
<div id="branding" ng-controller="ProyectosController">
            ...
            <div class="col-md-6">
                <form id="contactoForm" name="contactoForm">
                    ...
                    <input type="text" class="form-control" id="fuente" name="fuente" ng-model="contacto.fuente" ng-init="contacto.fuente='Google'"
                        hidden required>
                    <input type="text" class="form-control" id="tipo" name="tipo" ng-model="contacto.tipo" ng-init="contacto.tipo='Branding Colombia'"
                        hidden required>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 text-center info-descripBranding">
                    ...
                    <p class="text-small small-gray text-left">
                        <span class="c-grayLight">+ Nombres de marca (Naming) </span>
                      Creamos propuestas únicas y creativas de posibles nombres hasta llegar al nombre ideal para el negocio; siempre tomando en cuenta su viabilidad de registro ante el IMPI.
                    </p>
                    <p class="text-small small-gray text-left">
                        <span class="c-grayLight">+ Concepto creativo.</span>
                      Creamos un concepto que refleje el núcleo del negocio, los elementos visuales que aluden al nombre y los valores a comunicar.
                    </p>
                </div>
                <div class="col-md-6 text-center info-descripBranding">
                    <p class="text-small small-gray text-left">
                        <span class="c-grayLight">+ Propuestas de identidad corporativa.</span>
                      Se generan tres diferentes caminos gráficos justificados creativamente; a partir de la versión seleccionada por el cliente se realizan las diferentes aplicaciones gráficas previamente acordadas.
                    </p>
                    <p class="text-small small-gray text-left">
                        <span class="c-grayLight">+ Manual de identidad.</span>
                    Construimos un manual de identidad en donde definimos la forma en que se comporta gráficamente nuestra identidad en sus diferentes aplicaciones on y offline. Sus usos y restricciones, pantones, patronajes, tipografías, áreas de protección, etc.
                    </p>
                    <p class="text-small small-gray text-left">
                        <span class="c-grayLight">+ Slogan.</span>
                      Cuando la marca lo requiere, se propone una frase a través de la cual se comunica de manera puntual, amigable y atractiva los valores principales de la marca.
                    </p>
                    {{-- <p class="text-small small-gray text-left">
    ...
    <section id="plug">
        <a href="{{ url('colombia/branding/#contact') }}">
