...
<div id="branding" ng-controller="ProyectosController">
            ...
            <div class="col-md-6">
                <form id="contactoForm" name="contactoForm">
                    ...
                    <input type="text" class="form-control" id="fuente" name="fuente" ng-model="contacto.fuente" ng-init="contacto.fuente='Google'"
                        hidden required>
                    <input type="text" class="form-control" id="tipo" name="tipo" ng-model="contacto.tipo" ng-init="contacto.tipo='Branding USA'"
                        hidden required>
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-center info-descripBranding">
                    ...
                    <p class="text-small small-gray text-left">
                        ...
                        We create unique and creative naming proposals until the perfect business identity is found; always considering trademarking viability with the Mexican Institute of Intelectual Property.
                    </p>
                    <p class="text-small small-gray text-left">
                        <span class="c-grayLight">+ Creative concepts.</span>
                        We create concepts that reflect the business core, the visual elements that follow the name, and the values that we want to communicate.
                    </p>
                </div>
                <div class="col-md-6 text-center info-descripBranding">
                    <p class="text-small small-gray text-left">
                        <span class="c-grayLight">+ Branding.</span>
                        We generate 3 different graphic paths that are creatively justified according to the client´s selected option, we then provide a series of graphic applications for the overall use of brand.
                    </p>
                    <p class="text-small small-gray text-left">
                        <span class="c-grayLight">+ Identity Manual.</span>
                        We build brand and corporate identity manuals where we define the graphic behaviour of the business identity throughout its different applications, on and offline. Its uses, restrictions, pantones, pattern designing, typography, protection areas, etc.
                    </p>
                    <p class="text-small small-gray text-left">
                        <span class="c-grayLight">+ Slogan.</span>
                        According to the brand´s needs, we propose a phrase that delivers the main identity values in a clear, friendly and attractive way.
                    </p>
                    {{-- <p class="text-small small-gray text-left">
    ...
    <section id="plug">
        <a href="{{ url('usa/branding/#contact') }}">
