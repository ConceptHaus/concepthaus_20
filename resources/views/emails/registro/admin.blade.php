																			...
																			<tbody>
																				<tr>
																					<td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
																						...
																						<img align="center" alt="" src="https://gallery.mailchimp.com/766ee0c962d543c02140cdccb/images/9be8cc1f-9e89-4783-9c13-f398e2262ad1.gif"
																						    width="502" style="max-width:502px; padding-bottom: 0; display: inline !important; vertical-align: bottom;"
																						    class="mcnImage">
															...
															<tr>
																<td align="center" valign="top">
																	...
																	<table border="0" cellpadding="0" cellspacing="0" width="100%" id="">
																		<tr>
																			<td valign="top" class="headerContainer" style="padding-top:20px; padding-bottom:20px;">
																												...
																												<h1 style="text-align: center; letter-spacing:2px; font-weight:100">
																													<span style="font-family:roboto,helvetica neue,helvetica,arial,sans-serif">
																														<span style="font-size:32px">
																															<span style="color:#FFFFFF">NUEVO LEAD</span>
																														</span>
																													</span>
																												</h1>
																									...
																									<tbody>
																										<tr>
																											...
																											<td style="padding-top:9px; padding-left:18px; padding-bottom:9px; padding-right:18px;">
																												...
																												<table border="0" cellspacing="0" class="mcnTextContentContainer" width="100%" style="min-width: 100% !important;background-color: #4B4F54;">
																													<tbody>
																														<tr>
																															<td valign="top" class="mcnTextContent" style="padding: 18px;color: #258093;font-family: Helvetica;font-size: 14px;font-weight: normal;text-align: center;">
																																<h1 class="null" style="text-align: left;">
																																	...
																																	<span style="color:#fffff; font-size: 15px; letter-spacing: 1px;">{{$nombre}}</span>
																																</h1>
																															</td>
																														</tr>
																													</tbody>
																													...
																													<tbody>
																														<tr>
																															<td valign="top" class="mcnTextContent" style="padding: 18px;color: #258093;font-family: Helvetica;font-size: 14px;font-weight: normal;text-align: center;">
																																<h1 class="null" style="text-align: left;">
																																	<span style="font-size:16px">
																																		<font color="#ffffff" face="lato, helvetica neue, helvetica, arial, sans-serif">CORREO</font>
																																	</span>
																																	<span style="color:#258093">&nbsp; &nbsp;&nbsp;</span>
																																	<span style="color:#fffff; font-size: 15px; letter-spacing: 1px;">{{$correo}}</span>
																																</h1>
																														...
																														<tr>
																															<td valign="top" class="mcnTextContent" style="padding: 18px;color: #258093;font-family: Helvetica;font-size: 14px;font-weight: normal;text-align: center;">
																																<h1 class="null" style="text-align: left;">
																																	<span style="font-size:16px">
																																		<span style="font-family:lato,helvetica neue,helvetica,arial,sans-serif">
																																			<font color="#ffffff">TELÉFONO</font>
																																		</span>
																																	</span>
																																	<span style="color:#258093">
																																	<span style="font-size:16px">&nbsp;</span>&nbsp;&nbsp;</span>
																																	<span style="color:#fffff; font-size: 15px; letter-spacing: 1px;">{{$telefono}}</span>
																																</h1>
																													...
																													<tbody>
																														<tr>
																															<td valign="top" class="mcnTextContent" style="padding: 18px;color: #258093;font-family: Helvetica;font-size: 14px;font-weight: normal;text-align: center;">
																																<h1 class="null" style="text-align: left;">
																																	<span style="font-size:16px">
																																	<font color="#ffffff" face="lato, helvetica neue, helvetica, arial, sans-serif">EMPRESA&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</font>
																													...
																													<tbody>
																														<tr>
																															<td valign="top" class="mcnTextContent" style="padding: 18px;color: #258093;font-family: Helvetica;font-size: 14px;font-weight: normal;text-align: center;">
																																<h1 class="null" style="text-align: left;">
																																<span style="font-size:16px">
																																	<font color="#ffffff" face="lato, helvetica neue, helvetica, arial, sans-serif">MENSAJE&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</font>
																			...
																			<tbody>
																				<tr>
																					<td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
																						...
																						<img align="center" alt="" src="https://gallery.mailchimp.com/766ee0c962d543c02140cdccb/images/fea7ba39-8eb8-41d4-99cd-ab713a720085.png"
