...
<head>
   ...
   <!--  <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
    ...
    <!-- Google tag (gtag.js) --> <script async src="https://www.googletagmanager.com/gtag/js?id=AW-631785894"></script> <script> window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'AW-631785894'); </script>
</head>

<body ng-app="app">
     <!-- Google Tag Manager (noscript) Diciembre 2023-->
     <noscript>
        <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TKWP5GV4"
