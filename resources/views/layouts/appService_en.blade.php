...
<head>
    ...
    <title>ConceptHaus / Advertising Agency / Web Development / SEO and Digital Marketing in Mexico City </title>
    <meta name="description" content="We are a creative cluster specialized in the creation, development and empowerment of brands. "/>
    <!-- Facebook -->
    <meta property="og:locale" content="en_US">
    <meta property="og:title" content="ConceptHaus / Advertising Agency / Web Development / SEO and Digital Marketing in Mexico City "/>
    <meta property="og:image" content="{{asset('img/image-meta.png')}}"/>
    <meta property="og:description" content="We are a creative cluster specialized in the creation, development and empowerment of brands. "/>
    <meta property="og:type" content="website" />
    <meta property="og:url" content="https://concepthaus.mx/" />
    <meta property="og:site_name" content="Concept Haus" />
    <!-- Twitter -->
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:description" content="We are a creative cluster specialized in the creation, development and empowerment of brands. "/>
    <meta name="twitter:title" content="ConceptHaus / Advertising Agency / Web Development / SEO and Digital Marketing in Mexico City "/>
...
<body ng-app="app">
    ...
    <div>
        ...
        <header class="nav-down">
            <div class="row align-items-center">
                <div class="col-12 content-logo-eng">
                    <a href="{{ url('/') }}">
                ...
                <div class="col-sm-12 col-md-2 col-lg-2 socialIcons text-right">
                    ...
                    <a href="https://api.whatsapp.com/send?phone=5215543900616" target="_blank">
    ...
    <script src="/angular-app/controllers/RegistroController_en.js"></script>
    ...
    <script src="{{asset('js/isteven-multi-select_en.js')}}"></script>
