            ...
            <div class="card">
                <div class="card-content table-responsive">
                    ...
                    <table class="tablesaw table-hover" data-tablesaw-mode="stack">
                        ...
                        <tbody>
                            <tr ng-repeat="registro in statusCheck | filter:search | filter:{id_status:fecha.selectTypeStatus} | filter:{fuente:fecha.selectTypeFuente} | orderBy:sortType:sortReverse">
