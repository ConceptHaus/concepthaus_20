...
<div id="registro-detalle" class="row">
  @foreach ($postulados as $key => $postulado)
    <div class="col-lg-6 col-md-6 col-sm-6">
        ...
        <div class="card">
            ...
            <div class="card-header" data-background-color="grayDark">
                <h4 class="title">Vacante</h4>
                <p class="category">{{$vacante['titulo']}}</p>
            </div>
            <div class="card-content">
              <div class="card card-stats">
                <div class="card-content">
                  <p class="category">Nombre: {{$postulado['nombre']}} {{$postulado['apellido']}} </p>
                  <p class="category">Fecha de registro: {{$postulado['created_at']}}</p>
                </div>
            </div>
            <div class="card card-stats card-info-form">
                    <div class="row">
                        <div class="col-md-12">
                          <label class="label-registro">CV</label><br>
                          @if ($vacante['cv']===1)
                            <a href="{{$postulado['url_cv']}}" target="_blank">Ver CV</a>
                            @else
                              <p>No cuenta con CV</p>
                          @endif
                        </div>
                        <div class="col-md-12">
                            <label class="label-registro">Portafolio</label><br>
                            @if ($vacante['portafolio']===1)
                              <a href="{{$postulado['url_portafolio']}}" target="_blank">Ver Portafolio</a>
                              @else
                                <p>No cuenta con Portafolio</p>
                            @endif
                        </div>
                    </div>
            </div>
            <div class="card card-stats card-info-form">
                    <div class="row">
                        <div class="col-md-12">
                          <label class="label-registro">Contactar</label><br>
                          <a href="mailto:{{$postulado['correo']}}?&subject=ConceptHaus&body=Hola,%20gracias%20por%20contactarnos,%20hemos%20recibido%20tu%20solicitud%20para%20la%20vacante%20{{$vacante['nombre']}}.%20En%20breve%20nuestro%20equipo%20se%20pondrá%20en%20contacto%20contigo.%20ConceptHaus…%20#AccentingEverything."><button type="button" class="btn btn-gray btn-table-action btn-mail"><i class="far fa-envelope" aria-hidden="true"></i></button></a>
                        </div>
                    </div>
            </div>
          </div>
