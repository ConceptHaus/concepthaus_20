            ...
            <div class="card">
                <div class="card-content table-responsive">
                    ...
                    <table class="tablesaw table-hover" data-tablesaw-mode="stack">
                        ...
                        <tbody>
                            <tr dir-paginate="registro in statusCotizado | itemsPerPage: 15 | filter:search | filter:{id_status:fecha.selectTypeStatus} | filter:{fuente:fecha.selectTypeFuente} | orderBy:sortType:sortReverse | limitTo:10">
