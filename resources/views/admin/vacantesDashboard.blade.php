...
@section('content')
    <div class="container-fluid" ng-controller="VacantesController" ng-cloak>
    <div class="row">
        <div class="col-md-12">
            <div class="card card-transparent">
                <div class="card-header card-title-gral" data-background-color="white">
                    <h4 class="title">Vacantes</h4>
                    <p class="category">En esta sección se podrán visualizar las vacantes disponibles.</p>
                    <a href="{{ url('/createJob') }}" class="btn btn-red btn-card-header">
                      <i class="material-icons">work</i> Registrar Vacante
                    </a>
        ...
        <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="card card-stats">
                ...
                <div class="card-content">
                    <p class="category">Total de vacantes</p>
                    <h3 class="title"><% vacantesPostulados.length %></h3>
                </div>
        ...
        <div class="col-sm-6 col-md-6 col-lg-6">
            <div class="card">
                <div class="card-header card-chart" data-background-color="grayDark">
                    <div class="ct-chart" id="emailsSubscriptionChartCotizado"></div>
                </div>
                <div class="card-content">
                    ...
                    <table class="tablesaw table-hover" data-tablesaw-mode="stack">
                        ...
                        <tbody>
                          {{-- dir-paginate="registro in statusCotizado | itemsPerPage: 15  --}}
                            <tr ng-repeat="vacante in vacantesPostulados | filter:search">
                                ...
                                <td>
                                  ...
                                  <span><% vacante.areas.area %></span>
                                </td>
                                <td>
                                  <span ng-if="vacante.postulados === null"> 0 </span>
                                  <span ng-if="vacante.postulados != null"><% vacante.postulados.length %></span>
                                </td>
